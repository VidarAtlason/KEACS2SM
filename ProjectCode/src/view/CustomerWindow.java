...
public class CustomerWindow extends JFrame
{
	...
	// FocusTraversalOnArray(new Component[]{txtCountryCode, lblCountryCode,
	// txtPhoneNumber, lblPhoneNumber, txtEmail, lblEmail, txtStreetName,
	// lblStreetName, txtStreetNumber, lblStreetNumber, txtCity, lblZipCode,
	// lblNewLabel_1, txtPaymentInfo, chbCompany, btnSave, txtZip,
	// lblCountry, textField_1, lblId, lblCompanyName, txtCompanyName,
	// lblCvr, txtCVR, lblFaxno, txtFaxNo, lblContactPerson,
	// txtContactPersonName, lblContactPhoneno, txtContactPhoneNo, private1,
	// company, lblNewLabel, txtFirstName, lblLastName, txtLastName,
	// lblBirthdate, txtBirthDate, lblGender, cbGender}));
	company.setVisible(false);
    }
    ...
    {
	return new Company(0, txtEmail.getText(), txtPhoneNumber.getText(), txtStreetName.getText(), txtStreetNumber.getText(), zips.get(cbZip.getSelectedIndex()), countries.get(cbCountries.getSelectedIndex()).getId(), txtCompanyName.getText(), txtCVR.getText(), txtFaxNo.getText(), txtContactPersonName.getText());
    }
	...
	return new PrivateCustomer(0, txtEmail.getText(), txtPhoneNumber.getText(), txtStreetName.getText(), txtStreetNumber.getText(), zips.get(cbZip.getSelectedIndex()), countries.get(cbCountries.getSelectedIndex()).getId(), txtFirstName.getText(), txtLastName.getText(), (cbGender.getSelectedIndex() == 1) ? true : false, c);
    }
