...
/**
 * 
 * @author ai This is a test window - supposedly to check that a new reservation
 *         is added. Refactoring might be required This may later be expanded to
 *         a real tab in the application to show all reservations
 *
 */
