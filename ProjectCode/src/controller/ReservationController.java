...
public class ReservationController
{
	...
	{
	    // update of selected week/year to make sure that user cannot choose
	    // a negative time window
		...
		{
		    // calculate the price from all parameters and display price
		    // in frame
		    double price = 0;
		    price = newReservation.calculatePrice();
		    frame.setPricelabel("" + price + " DKK");

		    // get the Customer from selected customer in combobox and
		    // get discount for customer and display discount amount in
		    // frame
     ...
     * @param weekNo
     * @param yearNo
     * @return an integer representation of week and year; for example week 12
     *         year 2014 will be converted to 201412. See project document for
     *         further explanation
     */
